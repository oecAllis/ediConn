...
/**
 * Created by Allis Kuo on 2019-03-20 This class is used to know at current time frame, how many edi
 * files need to be handled concurrently Also it needs to keep track of vendor, edi file lists so
 * that once jobs are done properly, remove edi files accordingly
 */
